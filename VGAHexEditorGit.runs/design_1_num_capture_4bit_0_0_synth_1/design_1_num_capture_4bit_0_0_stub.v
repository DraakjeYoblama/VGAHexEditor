...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(iClk, iRst, iPush, iStop, oLEDs, oAddr, oData, oWe)
/* synthesis syn_black_box black_box_pad_pin="iClk,iRst,iPush,iStop,oLEDs[3:0],oAddr[9:0],oData[11:0],oWe" */;
  input iClk;
  input iRst;
  input iPush;
  input iStop;

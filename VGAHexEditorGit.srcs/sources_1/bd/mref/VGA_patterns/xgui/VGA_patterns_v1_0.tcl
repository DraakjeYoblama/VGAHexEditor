...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "H_PF" -parent ${Page_0}
...
proc update_PARAM_VALUE.H_PF { PARAM_VALUE.H_PF } {
	# Procedure called to update H_PF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.H_PF { PARAM_VALUE.H_PF } {
	# Procedure called to validate H_PF
	return true
}
...
proc update_MODELPARAM_VALUE.H_PF { MODELPARAM_VALUE.H_PF PARAM_VALUE.H_PF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.H_PF}] ${MODELPARAM_VALUE.H_PF}
}
